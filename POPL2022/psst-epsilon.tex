...
\item $\delta \in Q \times \Sigma \rightarrow \overline{Q}$, 
...
\item $E$ associates with each transition a string-variable assignment function, that is, $E$ is partial function from $Q \times \Sigma^\varepsilon \times
...
The size of $\psst$, denoted by $|\psst|$, is defined as $\sum \limits_{(q, a, q') \in \dom(E)} \sum_{x \in X} |E((q, a, q'))(x)|$, where $|E((q, a, q'))(x)|$ is the length of $E(q, a, q')(x)$, i.e. the number of symbols from $X \cup \Sigma$ in it.

...
computing images and pre-images of string functions. We deliberately
...
Appendix~\ref{app-pre-image}. Moreover, we have already known that $\extract$ is equivalent to a PSST (see Section~\ref{sec:logic}). The reduction of

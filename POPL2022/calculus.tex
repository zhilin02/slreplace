...
Appendix~\ref{app-pre-image}. Moreover, we have already shown in Lemma~\ref{lem-str-fun-to-psst} that $\extract$, $\replace$, and $\replaceall$ can be reduced to PSSTs.

...
\section{A String Constraint Language}
...
We start with a definition of regular expressions tailored to its usage in modern programming language. 
...
%\subsection{The String Constraint Language}\label{sec:logic}

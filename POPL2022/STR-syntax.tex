...
We start with the syntax of regular expressions %tailored to its usage in modern programming language. We shall start with the syntax of regular expressions, 

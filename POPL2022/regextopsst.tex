...
Finally, we construct $\cT_e$ from $\cT^{(m_1)}_{e_1} \concat \cT^\prime_{e_1^{\{1,m_2-m_1\}}}$, the concatenation of $\cT^{(m_1)}_{e_1}$ and $\cT^\prime_{e_1^{\{1,m_2-m_1\}}}$, by adding a fresh state $q_{e,0}$, a string variable $x_e$, the $\varepsilon$-transition $\tau_e(q_{e,0}) = ((q_{e_1,0});())$ (assuming that $q_{e_1,0}$ is the initial state of $\cT^{(m_1)}_{e_1}$),  and the assignments $E_e(q_{e_0}, \varepsilon, q_{e_1,0})(x_e) = \varepsilon$, as well as $E_e(p, a, q)(x_e) = x_e a$ for each transition $(p, a, q)$ in  $\cT^{(m_1)}_{e_1} \concat \cT^\prime_{e_1^{\{1,m_2-m_1\}}}$.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Case $e = [e_1^{\{m_1,m_2\}?}]$} Then $\cT_e$ is constructed as the concatenation of $\cT^{(m_1)}_{e_1}$ and $\cT^\prime_{e_1^{\{1,m_2-m_1\}?}}$, where $\cT^\prime_{e_1^{\{1,m_2-m_1\}?}}$ is illustrated in Fig.~\ref{fig-reg2pfa-5}, which is the same as $\cT^\prime_{e_1^{\{1,m_2-m_1\}}}$ in Fig.~\ref{fig-reg2pfa-4}, except that the priorities of the $\varepsilon$-transition from $q^{(1)}_{e_1,0}$ to $f^\prime_0$ has the highest priority and  the priorities of the $\varepsilon$-transitions out of each $f^{(i)}_{e_1,2} \in F^{(i)}_{e_1,2}$ to $f^\prime_1$ are swapped.
		\begin{figure}[ht]
			\centering
			%\rule{\linewidth}{0cm}

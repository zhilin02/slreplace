...
\philipp{why not add negation and disjunctions as well?}\zhilin{added, but when we define straight-line fragment, we assume that there is no negation or disjunction ?}
\[
\begin{array}{l c l}
\smallskip

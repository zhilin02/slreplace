...
On the other hand, regular expressions in programming languages ({\regexp}) such as JavaScript, feature non-standard semantics of operators 
...
performs a kind of propagation of regular constraints by means of 

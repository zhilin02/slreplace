...
In programming languages such as JavaScript, REs feature non-standard semantics of operators (e.g. non-commutative union and
greedy/lazy Kleene star), as well as additional features such as capturing
...
The approach utilizes a string constraint language including \regexp{}-dependent string functions such as extract and replace(all). 
%
...
The approach solves the string constraints by using a sequent calculus that exploits nice closure and algorithmic properties of
...
In particular, we show that {\PSST} preserves regularity, i.e. pre-images of regular constraints under {\PSST} are still regular. 
...
%
We evaluate its performance on over 195\,000 string constraints generated from open-source programs. The experimental results show the efficacy

...
In programming languages such as JavaScript, REs features non-standard semantics of operators (e.g. non-commutative union and
...
The key idea of our approach is to introduce a new automata model, called \emph{prioritized streaming string transducers} (PSST), to model the string functions involving \regexp{}.
...
model capturing groups. We carry out thorough empirical studies
...
%
We formulate a string constraint language including complex string functions such as extract and replace(all), and provide a sequent calculus that exploits nice closure and algorithmic properties of

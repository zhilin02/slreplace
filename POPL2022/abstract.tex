...
%% contribution
While symbolic execution of programs containing {\regexp}s appeals for string solvers natively supporting important features of \regexp{}, such a string solver is hitherto missing.  
%
In this paper, 
%we advocate that string solvers should natively support
%important features of \regexp{} and 
we propose the first string theory and string solver that natively provide such a support.
...
Our string solver relies on a sound sequent calculus that exploits nice closure and algorithmic properties of

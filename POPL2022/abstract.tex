...
%% contribution
While symbolic execution of programs containing {\regexp}s appeals to string solvers natively supporting important features of \regexp{}, such a string solver is hitherto missing.  
%
In this paper, we propose the first string theory and string solver that natively provide such a support.

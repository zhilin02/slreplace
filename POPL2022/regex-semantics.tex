...
\section{Formal Semantics of Regex-string Matching In JavaScript}\label{sec-rwre}
Our goal in this section is to define the formal semantics of regex-string matching in JavaScript. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\OMIT{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{From regular expressions to PSSTs} \label{sect:regextopsst}

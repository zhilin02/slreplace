...
%\zhilin{I think we should be careful  about the complexity here, since the current transformation from Regexes to PSSTs with two disjoint subsets of final states does incur an exponential blow-up (See Section 3).}

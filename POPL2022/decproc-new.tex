...
decidability of the path feasibility of $\strline_{\sf reg}$. To this
end we define a terminating strategy to apply the rules in
Table~\ref{tab:calculus} to a formula in the $\strline_{\sf reg}$
fragment:
\begin{itemize}
...
\item \emph{Phase 2:} apply rule~\ruleName{Bwd-Prop} to all regex
  ...
  equations.  This phase terminates because $\strline_{\sf reg}$

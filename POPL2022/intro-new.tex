...
\begin{example}\label{ex:normalize}
    ...
    Consider the snippet in Figure 
...
benchmarks) suggests that our solver substantially outperforms the existing 
method (i.e.  \cite{LMK19}); by 30--50-fold in our benchmarking. 
%We provide 
...
expressions of \cite{LMK19} across 415,487 NPM packages. More importantly, we 
have performed an extensive experiment

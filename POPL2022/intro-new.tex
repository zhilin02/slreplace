...
\cite{aratha,LMK19}) by 30x-50x. \zhilin{I think Aratha should be removed here. We do not compare with Aratha, since it is unable to deal with Regexes.}\philipp{agreed. we should also say what parameter 30x-50x refers to} We provide more details of our contributions
below.

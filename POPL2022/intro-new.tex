...
As a result, string-manipulating programs are
...
Many important string functions in programming languages, such as exec, test, search, match, replace, and split in Javascript, as well as match, findall, search, sub, and split in Python, depend on regular expressions. 

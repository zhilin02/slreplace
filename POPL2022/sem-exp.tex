...
For instance, for the pair $(*?, *)$, we generate the {\regexp} expression $[([\mathbb{S}^*?])^{*}]$. In then end, we generate $10+10*10+10*10*10 = 1110$ {\regexp} expressions. \zhilin{the number to be checked}

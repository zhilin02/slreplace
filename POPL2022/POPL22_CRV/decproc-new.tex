...
\mat{change}
Since the PSST $\cT$ may be exponential in the size of the underlying regular expression, we may compute automata up to doubly exponential in size.
\mat{QUESTION: does this mean we have an EXPSPACE algorithm?}
\mat{endchange}

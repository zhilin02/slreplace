...
\color{red}
EMU focuses on SL, and implements the procedure in Theorem 5.7. In addition, similar to other SMT solvers, EMU applies simplification rules to formulas before invoking the SL procedure. See the rules in Table 1, in particular Fwd-Prop-Elim, =-Prop, Subsume, Close, etc. This enables EMU to solve formulas outside of the SL fragment, but is not a complete procedure for non-SL formulas. We can add more details in the next version.
\color{black}

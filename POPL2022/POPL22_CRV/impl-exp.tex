...
\begin{table}[t]
  ...
  \label{tab:exp-r2}
    ...
    wall-clock time needed per benchmark, and counts timeouts as 120s. \#T.O.\& Err is the number of timeouts. Note that some paths may have already been covered before T.O. }
	\label{tab:exp-r1}
\end{table}

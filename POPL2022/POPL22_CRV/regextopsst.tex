...
{
\begin{remark}
	[Berglund and van der Merwe 2017a] do not address some “tricky” regex, i.e., regexes containing the empty word. Our solution is to have separate, accepting states for empty and non-empty words respectively. We sometimes need two copies of automata to respect this separation. The necessity of this separation is better explained by examples e.g. (a*?)*, which will be added.
\end{remark}
}

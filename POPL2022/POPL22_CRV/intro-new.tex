...
Next, by means of a sound sequent calculus, our string solver (implemented in 
...
We implement our decision procedure 
%in a new solver \ostrich\  
on top of the open-source solver~OSTRICH~\cite{CHL+19},
...
%\philipp{this should be reformulated; earlier we claim

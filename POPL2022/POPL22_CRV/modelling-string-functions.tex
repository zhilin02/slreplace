...
Full formal details are given in \ifproceeding the full version of the paper \cite{popl22-full}. \else Appendix~\ref{appendix:sec-extract-replace-to-psst}. \fi
...
The full reduction is given in the 

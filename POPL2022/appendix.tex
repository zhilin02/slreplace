...
\begin{lemma}\label{lem-str-fun-to-psst}
    The satisfiability of $\strlinesl$ reduces to the satisfiability of the string constraints that are a conjunction of the formulas of the form $z=x \concat y$, $y=\cT(x)$, and $x \in \cA$, where $\cT$ is a PSST and $\cA$ is an FA.
\end{lemma}

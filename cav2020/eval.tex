...
Table~\ref{tab-experiment} summarizes the experimental results, where '--' means that the tool is not applicable to the benchmark, and 'inconclusive' means that a tool gave up, timed out, or crashed. We did not observe incorrect answers by any tool.

...
The findings are as follows:  {\ostrich}+ can solve all the 94 instances from the {\transducerbench}+ benchmark suite, which, in our evaluation, is the only solver that is able to deal with this benchmark suite. 
...
For the {\pyexztbench} benchmark suite, {\zthreetrau} is the best, solving almost all instances. %, except 17 of them. 
...
For the {\kaluzabench} benchmark suite, {\cvc} performs the best since it solves almost all the instances. %, except 6 of them. 

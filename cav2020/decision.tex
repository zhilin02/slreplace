...
For each integer term of the form $\indexof_v(x,i)$ in $S$, nondeterministically choose one of the following to do.
\begin{itemize}
...
The proof of Proposition~\ref{prop:la-sat-cefa-inter} can be found in the appendix. \zhilin{describe the main idea here since in the implementation, we need to say that symbolic approach is used to avoid the state explosion problem.}

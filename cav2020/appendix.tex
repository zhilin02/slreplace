...
\zhilin{@Anthony, please write your proof here.} Use Proposition 16 in \cite{LB16}.
\end{proof}



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Algorithms for case splits in the semantics of $\indexof_v$ and $\substring$}
...
\caption{$\mathit{indexofCaseSplit}$}\label{alg:indexof}
\end{algorithm}
...
\caption{$\mathit{substringCaseSplit}$}\label{alg:substring}
\end{algorithm}

...
Recently, researchers have also explored the decidability of string theories with more complex string operations and integer data type. Lin and Barcelo showed that the straight-line string logic with concatenation, finite transducers, and regular constraints, is decidable, even when extended with length, letter-counting functions, as well as $\indexof$ and $\charat$ functions \cite{LB16}. \zhilin{say a few more words about its relationship with this paper} 

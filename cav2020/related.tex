...
with respective dynamic symbolic execution engines, Saner \cite{Saner08}, Kaluza~\cite{Berkeley-JavaScript}, Hampi~\cite{HAMPI},  Z3-str/Z3-str2/Z3-str3~\cite{Z3-str,Z3-str2,Z3-str3}, {\cvc}~\cite{cvc4,ReynoldsWBBLT17}, Stranger~\cite{YABI14,Stranger},  S3 and S3P~\cite{S3,TCJ16}, ACO-Solver \cite{ThomeSBB17}, FAT~\cite{Abdulla17}, Trau/{\zthreetrau}/{\trauplus} \cite{AbdullaACDHRR18-trau,AbdullaA+19,Z3-trau}, 
%

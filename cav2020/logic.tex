...
After adapting the syntax of the program corresponding to the ``if'' branch of {\tt urlXssSanitise(url)} in Section~\ref{exmp:running}, %we get the following {\slint} program $S$,
\[ 
\begin{array}{l}

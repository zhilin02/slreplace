...
\begin{remark}
The function ${\sf charAt}(x, i)$ which returns $x[i]$ (i.e., the character of $x$ at the position $i$) can be seen as a special case of $\substring$, namely ${\sf charAt}(x, i) \equiv \substring(x, i, 1)$.
\end{remark}

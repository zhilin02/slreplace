...
makes it difficult for symbolic execution engines to handle RWREs, where approximation of RWREs are usually needed. 
%
%For instance,
%%which are hitherto 
...
in prioritized finite-state automata to capture greedy/non-greediness semantics,
...
We evaluate its performance on over 195\,000 string constraints generated 
from RWREs in open-source programs. The experimental results show the efficacy of our approach, drastically improving the state-of-the-art symbolic execution engines in  both precision and efficiency. 

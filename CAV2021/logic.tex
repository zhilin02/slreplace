...
\emph{pattern} $\pat \in \regexp$ and the \emph{replacement} string $\rep \in \refexp$. For a given input string $x$, the function identifies all the %the first, second, $\dots$, 

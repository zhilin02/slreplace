...
%
	\item  for the $\replace$ and $\replaceall$ operation, $\pat\in \cgexp$, $\rep \in \refexp$, %$\replaceall$ is the replace-all function to be defined shortly,
...
backreferences in assertion statements. %We state 

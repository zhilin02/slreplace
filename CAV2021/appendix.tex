...
\begin{table}[H]
	...
	\begin{tabular}{l@{\quad}c@{\quad}|*{2}{c}|@{\quad}*{2}{c}}
	  ...
	  \\\hline
	  \textbf{Regex-ExpoSE} & 69 & \textbf{68} & 1 & \textbf{68} & 1 
	  \\
	  && \multicolumn{2}{c|@{\quad}}{Average time: 10.01s} & \multicolumn{2}{c@{\quad}}{Average time: \textbf{3.95} s}
	  \\\hline
	  \textbf{Replace-JS} & 36 & 14 & 22 & \textbf{36} & 0
	  \\
	  && \multicolumn{2}{c|@{\quad}}{Average time: 17.46s} & \multicolumn{2}{c@{\quad}}{Average time: \textbf{2.81}s}
	  \\\hline
	  \textbf{Match-JS} & 35 &  28&   7& \textbf{35} & 0
	  \\
	  && \multicolumn{2}{c|@{\quad}}{Average time: 14.13s} & \multicolumn{2}{c@{\quad}}{Average time: \textbf{3.14}s}
	  \\
	\end{tabular}
	\end{center}

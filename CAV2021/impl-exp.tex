...
\begin{table}[tb]
    ...
    & &
	  ...
	  \\
	  && \multicolumn{5}{c|@{\quad}}{Average time: \textbf{7.88}s} & \multicolumn{5}{c@{\quad}|}{Average time: 13.72s}
	  \\\hline
	  \textbf{Match} & 28 & 3 & 7 & 12 & 6 & 0 & 3 & 8 & 12 & 5 & 0
	  \\
	  && \multicolumn{5}{c|@{\quad}}{Average time: \textbf{4.30}s} & \multicolumn{5}{c@{\quad}|}{Average time: 23.66s}
	  \\\hline
	  \textbf{Replace} & 38 & 12 & 20 & 6 & 0 & 0 & 12 & 23 & 3 & 0 & 0
	  \\
	  && \multicolumn{5}{c|@{\quad}}{Average time: \textbf{2.71}s} & \multicolumn{5}{c@{\quad}|}{Average time: 41.73s}
	  \\\hline
	\end{tabular}
	\end{center}

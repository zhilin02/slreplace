...
follows the targeted path.\philipp{Zhilin, how should this formulation
  be weakened?} \zhilin{Philipp, we do not need to weaken it. Denghang is trying to do the semantic comparison with Expose. He should be able to get the statistics before the Feb. 4.} The results are summarized in Table~\ref{tab:exp-r1};

...
\begin{table}[tb]
	...
	\hline
	   & &
	  \multicolumn{5}{c|@{\quad}}{\textbf{Aratha+\ostrich}} &\multicolumn{5}{c@{\quad}|}{\textbf{\expose{}+Z3}}
	  \\
    & &
	  \multicolumn{5}{c|@{\quad}}{solved paths within 60s} &\multicolumn{5}{c@{\quad}|}{solved paths within 60s}
	  \\
	  ...
	  \\
	  && \multicolumn{5}{c|@{\quad}}{Average time: 13.72s} & \multicolumn{5}{c@{\quad}|}{Average time: \textbf{7.88}s}
	  \\\hline
	  \textbf{Match} & 28 & 3 & 7 & 12 & 6 & 0 & 3 & 8 & 12 & 5 & 0
	  \\
	  && \multicolumn{5}{c|@{\quad}}{Average time: 23.66s} & \multicolumn{5}{c@{\quad}|}{Average time: \textbf{4.30}s}
	  \\\hline
	  \textbf{Replace} & 38 & 12 & 20 & 6 & 0 & 0 & 12 & 23 & 3 & 0 & 0
	  \\
	  && \multicolumn{5}{c|@{\quad}}{Average time: 41.73s} & \multicolumn{5}{c@{\quad}|}{Average time: \textbf{2.71}s}
	  \\\hline
	\end{tabular}
	\end{center}

...
\begin{table}[tb]
	...
	\hline
	  ...
	  \\
    & &
	  \multicolumn{6}{c|@{\quad}}{solved paths within 60s} &\multicolumn{6}{c@{\quad}|}{solved paths within 60s}
	  \\
	   & \#JS-Progs. & ~0~  & ~1~ &  ~2~ & ~3~ & ~$\geq$4~ & ~\#Timeout~ &
	    ~0~  & ~1~ &  ~2~ & ~3~ & ~$\geq$4~ & ~\#Timeout~
	  \\\hline
	  \textbf{\expose{}} & 57 & 16 & 12 & 12 & 2 & 15 & 0  & 17 & 8 & 13 & 4 & 15 & 1  
	  \\
	  && \multicolumn{6}{c|@{\quad}}{Average time: \textbf{7.88}s} & \multicolumn{6}{c@{\quad}|}{Average time: 13.72s}
	  \\\hline
    ...
    wall-clock time needed per benchmark, and counts timeouts as 60s.\zhilin{@denghang, update the statistics}}
	\label{tab:exp-r1}

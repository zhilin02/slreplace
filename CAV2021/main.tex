...
State-of-the-art string constraint solvers (e.g. CVC4 and Z3-str) do not support RWREs. Symbolic executors of string-manipulating programs have to resort to counter example guided abstraction and refinements (CEGAR) to mitigate the imprecise semantics of REs in the solvers. 
%

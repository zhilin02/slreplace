...
While REs are supported by every state-of-the-art string constraint solvers (e.g. CVC4 and Z3-str), none of them supports RWREs. The mismatch between REs in string constraint solvers and RWREs in programming languages hinders the precision and efficiency of symbolic executors, which have to resort to counter example guided abstraction refinements (CEGAR) to mitigate this issue. 
%

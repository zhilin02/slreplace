...
As a result, the state-of-the-art string constraint solvers (e.g. CVC4 and Z3-str) only support classical regular expressions.  
%
...
%% contribution
This work proposes a novel approach of supporting real-world regular expressions in string constraint solving. The kernel of this approach is a new automata model called prioritized streaming string transducers (PSST), which combines priorities in prioritized finite transducers and string variables in streaming string transducers. 
With PSSTs, real-world regular expressions can be conveniently modeled. 
...
Moreover, we design a decision procedure for string constraints with real-world regular expressions based on PSSTs. 
%% implementation and experiments
We implement the decision procedure and do extensive experiments to evaluate its performance. The experimental results on over 160,000 string constraints, which are generated from regular expressions in open-source programs, show that our implementation is able to tackle a wide range of real-world regular expressions quite efficiently. To the best of our knowledge, this work represents the first string constraint solver capable of dealing with real-world regular expressions.
\end{abstract}

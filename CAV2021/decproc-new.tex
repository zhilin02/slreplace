...
Formally, suppose $\cA_e = (Q, \Sigma, \delta, \tau, q_0, f_0)$, then $\cT_{\extract_{i,e}} = (Q, \Sigma, X, \delta, \tau, E, q_0, F)$ (see Figure~\ref{fig-psst-extract}), where 
\begin{itemize}
...
%
\item for each transition $(q_1, \sigma, q_2)$ in ${\sf Sub}_{e'}[\cA_e]$ with $\sigma \in \Sigma$, we have $E(q_1, \sigma, q_2)(x)=x\sigma$, and for all the other transitions $(q'_1, \sigma', q'_2)$, $E(q'_1, \sigma', q'_2)(x) = x$.
% 
\item $F(f_0) = x$.
\end{itemize}

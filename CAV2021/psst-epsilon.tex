...
For any pair of runs $p = q_0 a_1 s_1 \ldots a_m s_m q_m$ and $p' = q_0 a'_1
...
Note that in the definition of $\cR_\psst$ above, the inputs of $\psst$ whose outputs contain both $\nullchar$ and letters from $\Sigma$ are ignored.

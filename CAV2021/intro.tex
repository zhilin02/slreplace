...
Z3, CVC4, Z3-str/2/3/4, ABC, Norn, Trau, OSTRICH, S2S, Qzy, Stranger, Slog, Slent, Gecode+S, G-Strings, HAMPI... \anthony{make sure we add all}) therefore support
...
As to be expected, RWREs in real-world programs are also commonly used in 
combination with
...
in $e$. 
\begin{example}
    We give a fuller example in Section \ref{sec:mot}, which simultaneously 
    involves both match and replace.

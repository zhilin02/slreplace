...
In practice, RWREs are commonly used in combination with
other string operations, e.g. match and replace(all) functions \cite{LMK19}. The semantics of RWREs drastically affect the behaviors of these functions. 

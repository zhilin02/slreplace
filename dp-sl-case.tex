...
Correctness follows a similar argument to Proposition~\ref{prop-sat-sl-case} and is presented in Appendix~\cite{sec:dp-dl-correctness}.
\mat{How do we reference the appendix?}
Intuitively, Proposition~\ref{prop-sat-sl-case} shows that our decision procedure correctly eliminates occurrences of $\replaceall$ until only regular constraints remain.

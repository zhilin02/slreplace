...
The construction is slightly technical and can be found in Appendix~\ref{appendix:cefa_indexof}. Note that $\CEFA_{\indexof_v}$ does not model the corner cases in the semantics of $\indexof_v$, for instance, $\indexof_v(w, n) = -1$ if $v$ does not occur after the position $n$ in $w$.
...
The proof of Proposition~\ref{prop:pre-image} is given in Appendix~\ref{app:pre-image}.
...
%(See Appendix, Section~\ref{appendix:cefa_indexof} for the construction of $\CEFA_{\rm \indexof_v}$.) 
...
The proof can be found in Appendix~\ref{app:sat-cefa}.  
%\end{definition}
...
%%%%%% commented for space %%%%%%%%%%%%%%%
%
An example for illustrating the decision procedure can be found in Appendix~\ref{app:urlexample}.

...
The rest of this paper is structured as follows: Section~2 introduces the preliminaries. Section~3 defines the class of string-manipulating programs with integer data type. Section~4 presents the decision procedure. Section~5 is devoted to evaluations.  

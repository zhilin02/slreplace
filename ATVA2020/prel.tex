...
\paragraph*{Recognisable relations.} 
We assume familiarity with standard regular language. Recall that a regular language $L$ can be represented by a regular expression $e\in \regexp$ or equivalenced by a nondeterministic finite automaton (NFA) $\NFA$ whereby we usually write $ L=\Ll(e)=\Lang(\NFA)$.

...
We will also use standard  quantifier-free/existential linear integer arithmetic (LIA for short) formulae, which are typically ranged over by $\phi, \varphi$, etc. %, which is essentially Presburger 

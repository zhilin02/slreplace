...
\hline
\hline
\multirow{3}{*}{\slogbenchra(120)} & \cellcolor{Gray} sat &  \cellcolor{Gray}\bf{104}  & \cellcolor{Gray}$-$ & \cellcolor{Gray}$-$  & \cellcolor{Gray}? & \cellcolor{Gray}? &98 \cellcolor{Gray}\\
\cline{2-8}
 & unsat &11  &$-$  &$-$ & ? & ? &\bf{12}\\
\cline{2-8}
...
\hline
\hline
\multirow{3}{*}{\slogbenchr(3,391)} & \cellcolor{Gray} sat &  \cellcolor{Gray}\bf{1,309} & \cellcolor{Gray}878 & \cellcolor{Gray}$-$ & \cellcolor{Gray}? & \cellcolor{Gray}? & \cellcolor{Gray}584 \\
\cline{2-8}

...
\author{Taolue Chen\inst{1} \and Matthew Hague\inst{2} \and Jinlong He\inst{3} \and Denghang Hu\inst{3} \and Anthony Widjaja Lin\inst{4} \and Philipp R\"ummer\inst{5} % \and Albin Stjerna\inst{5}

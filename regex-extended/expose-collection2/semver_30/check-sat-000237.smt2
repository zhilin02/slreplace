...
(assert (not (= Constructed_Argument_2_elements_loose_1_t
        (str.++ (seq.unit #x73)
                (seq.unit #x74)
                (seq.unit #x72)
                (seq.unit #x69)
...
(assert (not (= Constructed_Argument_2_elements_loose_1_t
        (str.++ (seq.unit #x6e) (seq.unit #x75) (seq.unit #x6c) (seq.unit #x6c)))))
(assert (str.in.re |0 Fill 0| (re.union (str.to.re (seq.unit #x76)) (str.to.re ""))))
...
(assert (let ((a!1 (re.++ (re.range (seq.unit #x31) (seq.unit #x39))
  ...
  (str.in.re |0 Fill 4| (re.union a!1 (str.to.re (seq.unit #x30))))))
...
(assert (let ((a!1 (re.++ (re.range (seq.unit #x31) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
  (str.in.re |0 Fill 9| (re.union a!1 (str.to.re (seq.unit #x30))))))
...
(assert (let ((a!1 (re.++ (re.range (seq.unit #x31) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
  (str.in.re |0 Fill 14| (re.union a!1 (str.to.re (seq.unit #x30))))))
...
(assert (or (= |0 Fill 23| |0 Fill 22|) (= |0 Fill 23| (seq.unit #x30))))
...
(assert (or (= |0 Fill 32| (str.++ (seq.unit #x2e) |0 Fill 31|))
    (= |0 Fill 32| (str.++ (seq.unit #x2e) (seq.unit #x30)))))
(assert (let ((a!1 (re.++ (re.range (seq.unit #x31) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))
      (a!2 (re.* (re.union (str.to.re (seq.unit #x2d))
                           (re.range (seq.unit #x41) (seq.unit #x5a))
                           (re.range (seq.unit #x61) (seq.unit #x7a))
                           (re.range (seq.unit #x30) (seq.unit #x39))))))
(let ((a!3 (re.++ (re.* (re.range (seq.unit #x30) (seq.unit #x39)))
                  (re.union (str.to.re (seq.unit #x2d))
                            (re.range (seq.unit #x41) (seq.unit #x5a))
                            (re.range (seq.unit #x61) (seq.unit #x7a)))
                  a!2)))
(let ((a!4 (re.++ (str.to.re (seq.unit #x2e))
                  (re.union a!1 a!3 (str.to.re (seq.unit #x30))))))
(let ((a!5 (re.++ (re.union a!1 a!3 (str.to.re (seq.unit #x30))) (re.* a!4))))
  (str.in.re (str.++ |0 Fill 23| |0 Fill 32|) a!5))))))
(assert (= |0 Fill 33| (seq.unit #x2b)))
(assert (let ((a!1 (re.union (str.to.re (seq.unit #x2d))
                     (re.range (seq.unit #x41) (seq.unit #x5a))
                     (re.range (seq.unit #x61) (seq.unit #x7a))
                     (re.range (seq.unit #x30) (seq.unit #x39)))))
...
(let ((a!3 (re.++ (re.* (re.range (seq.unit #x30) (seq.unit #x39)))
                  (re.union (str.to.re (seq.unit #x2d))
                            ...
                            (re.range (seq.unit #x61) (seq.unit #x7a)))
                  (re.* a!2)))
      (a!6 (re.* (re.++ (str.to.re (seq.unit #x2e)) (re.++ a!2 (re.* a!2))))))
(let ((a!4 (re.++ (str.to.re (seq.unit #x2e))
                  (re.union a!1 a!3 (str.to.re (seq.unit #x30)))))
      (a!7 (re.union (re.++ (str.to.re (seq.unit #x2b))
                            (re.++ a!2 (re.* a!2))
                            a!6)
                     (str.to.re ""))))
(let ((a!5 (re.++ (str.to.re (seq.unit #x2d))
                  (re.union a!1 a!3 (str.to.re (seq.unit #x30)))
                  (re.* a!4))))
(let ((a!8 (re.++ (re.union (str.to.re (seq.unit #x76)) (str.to.re ""))
                  (re.union a!1 (str.to.re (seq.unit #x30)))
                  (str.to.re (seq.unit #x2e))
                  (re.union a!1 (str.to.re (seq.unit #x30)))
                  (str.to.re (seq.unit #x2e))
                  (re.union a!1 (str.to.re (seq.unit #x30)))
                  (re.union a!5 (str.to.re ""))
                  a!7)))
...
(assert (let ((a!1 (str.substr Constructed_Argument
      ...
      (a!3 (re.++ (re.range (seq.unit #x31) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))
      (a!4 (re.union (str.to.re (seq.unit #x2d))
                     (re.range (seq.unit #x41) (seq.unit #x5a))
                     (re.range (seq.unit #x61) (seq.unit #x7a))
                     (re.range (seq.unit #x30) (seq.unit #x39)))))
(let ((a!2 (str.substr a!1 0 (+ 1 ((_ str.whiteRight 0) a!1 (str.len a!1)))))
      (a!5 (re.++ (re.* (re.range (seq.unit #x30) (seq.unit #x39)))
                  (re.union (str.to.re (seq.unit #x2d))
                            (re.range (seq.unit #x41) (seq.unit #x5a))
                            (re.range (seq.unit #x61) (seq.unit #x7a)))
                  (re.* a!4)))
      (a!8 (re.* (re.++ (str.to.re (seq.unit #x2e)) (re.++ a!4 (re.* a!4))))))
(let ((a!6 (re.++ (str.to.re (seq.unit #x2e))
                  (re.union a!3 a!5 (str.to.re (seq.unit #x30)))))
      (a!9 (re.union (re.++ (str.to.re (seq.unit #x2b))
                            (re.++ a!4 (re.* a!4))
                            a!8)
                     (str.to.re ""))))
(let ((a!7 (re.++ (str.to.re (seq.unit #x2d))
                  (re.union a!3 a!5 (str.to.re (seq.unit #x30)))
                  (re.* a!6))))
(let ((a!10 (re.++ (re.union (str.to.re (seq.unit #x76)) (str.to.re ""))
                   (re.union a!3 (str.to.re (seq.unit #x30)))
                   (str.to.re (seq.unit #x2e))
                   (re.union a!3 (str.to.re (seq.unit #x30)))
                   (str.to.re (seq.unit #x2e))
                   (re.union a!3 (str.to.re (seq.unit #x30)))
                   (re.union a!7 (str.to.re ""))
                   a!9)))
  (or (not (str.in.re a!2 a!10))
      (= a!2
         (str.++ |0 Fill 0|
                 |0 Fill 4|
                 (seq.unit #x2e)

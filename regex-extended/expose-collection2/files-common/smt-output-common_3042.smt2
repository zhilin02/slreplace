...
(assert (not (= ExpandObjSwitcher_4 9.0)))
(assert (not (= ExpandObjSwitcher_4 10.0)))
(assert (not (= ExpandObjSwitcher_4 11.0)))
(assert (not (= ExpandObjSwitcher_4 12.0)))
(assert (= ExpandObjSwitcher_4 13.0))

...
(assert (not (= Constructed_Argument_elements_0_0_t "string")))
(assert (not (= Constructed_Argument_elements_0_0_t "number")))
(assert (not (= Constructed_Argument_elements_0_0_t "boolean")))
(assert (not (= Constructed_Argument_elements_0_0_t "object")))
(assert (not (= Constructed_Argument_elements_0_0_t "array_number")))
(assert (not (= Constructed_Argument_elements_0_0_t "array_string")))
(assert (not (= Constructed_Argument_elements_0_0_t "array_bool")))
(assert (= Constructed_Argument_elements_0_0_t "null"))

...
(let ((a!6 (str.in.re (str.substr a!2 0 (to_int a!5))
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             (str.to.re "+")
                             (re.* (re.range "\x00" "\xff"))))))
  (not a!6)))))))
...
(let ((a!2 (ite (<= (str.len Constructed_Argument) 0)
      ...
      (a!3 (str.len (str.substr Constructed_Argument
                                ...
                                (ite a!1
                                     ...
                                     (str.len |0 Fill 1|))))))
(let ((a!4 (to_real (ite (<= (str.len Constructed_Argument) 0) 0 a!3))))
(let ((a!5 (ite (>= (to_real (str.indexof a!2 "]=" 0)) (- 2.0))
                (+ 2.0 (to_real (str.indexof a!2 "]=" 0)))
                (+ 2.0 (to_real (str.indexof a!2 "]=" 0)) a!4))))
(let ((a!6 (+ (ite (<= (str.len Constructed_Argument) 0) 0 a!3)
              (to_int (* (- 1.0) a!5)))))
  (= (str.substr a!2 (to_int a!5) a!6) "")))))))
(assert (= |5 Fill 0| "+"))
(assert (= |5 Fill 3| "+"))
(assert (let ((a!1 (<= (+ (str.len Constructed_Argument) (* (- 1) (str.len |0 Fill 1|)))
               0)))
...
(let ((a!5 (str.in.re a!4
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             (str.to.re "+")
                             (re.* (re.range "\x00" "\xff"))))))
  (or (not a!5) (= a!4 (str.++ |5 Fill 1| "+" |5 Fill 2|)))))))))
(assert (let ((a!1 (<= (+ (str.len Constructed_Argument) (* (- 1) (str.len |0 Fill 1|)))
               0)))
(let ((a!2 (ite (<= (str.len Constructed_Argument) 0)
                ""
...
(assert (let ((a!1 (ite (>= (+ (str.len Constructed_Argument) (str.len |0 Fill 1|))
                ...
                0)))
(let ((a!2 (ite (>= (str.len |0 Fill 1|) (- 1)) (+ 1 (str.len |0 Fill 1|)) a!1)))
(let ((a!3 (<= (+ (str.len Constructed_Argument)
                  (* (- 1) (str.len |1 Fill 1|))
                  (* (- 1) a!2))
               0)))
(let ((a!4 (str.substr Constructed_Argument
                       a!2
                       (ite a!3
                            (+ (str.len Constructed_Argument) (* (- 1) a!2))
                            (str.len |1 Fill 1|)))))
(let ((a!5 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) a!2)) 0) "" a!4)))
  (not (= (to_real (str.indexof a!5 "]=" 0)) (- 1.0)))))))))

...
(let ((a!3 (str.substr (ite (<= (str.len Constructed_Argument) 0)
                       ...
                       0
                       (ite (>= a!1 0) a!1 (+ a!1 a!2)))))
(let ((a!4 (>= (+ (str.len |1 Fill 1|) (* (- 1) (str.len a!3))) 0))
      (a!6 (ite (>= (+ (str.len |1 Fill 1|) (str.len a!3)) (- 1))
                (+ 1 (str.len |1 Fill 1|) (str.len a!3))
                0)))
(let ((a!5 (ite (<= (str.len a!3) 0)
                ""
                (str.substr a!3 0 (ite a!4 (str.len a!3) (str.len |1 Fill 1|)))))
      (a!7 (ite (>= (str.len |1 Fill 1|) (- 1)) (+ 1 (str.len |1 Fill 1|)) a!6)))

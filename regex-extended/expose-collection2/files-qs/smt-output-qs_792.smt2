...
(let ((a!3 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) a!2)) 0)
                ...
                (str.substr Constructed_Argument
                            a!2
                            (+ (str.len Constructed_Argument) (* (- 1) a!2))))))
  (not (= (to_real (str.indexof a!3 "]=" 0)) (- 1.0)))))))
(assert (let ((a!1 (ite (>= (+ (str.len Constructed_Argument) (str.len |0 Fill 1|))
                    (- 1))
                (+ 1 (str.len Constructed_Argument) (str.len |0 Fill 1|))
                0)))
...
(let ((a!3 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) a!2)) 0)
                ...
                (str.substr Constructed_Argument
                            a!2
                            (+ (str.len Constructed_Argument) (* (- 1) a!2))))))
  (not (= (to_real (str.indexof a!3 "]=" 0)) (- 2.0)))))))
(assert (= |4 Fill 0| "+"))
(assert (= |4 Fill 3| "+"))
(assert (let ((a!1 (ite (>= (+ (str.len Constructed_Argument) (str.len |0 Fill 1|))
                    (- 1))
...
(let ((a!3 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) a!2)) 0)
                ...
                (str.substr Constructed_Argument
                            a!2
                            (+ (str.len Constructed_Argument) (* (- 1) a!2))))))
(let ((a!4 (ite (>= (to_real (str.indexof a!3 "]=" 0)) (- 1.0))
                (+ 1.0 (to_real (str.indexof a!3 "]=" 0)))
                (+ 1.0
                   (to_real (str.indexof a!3 "]=" 0))
                   (to_real (str.len a!3))))))
(let ((a!5 (str.in.re (str.substr a!3 0 (to_int a!4))
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             (str.to.re "+")
                             (re.* (re.range "\x00" "\xff"))))))
  (or (not a!5)
      (= (str.substr a!3 0 (to_int a!4)) (str.++ |4 Fill 1| "+" |4 Fill 2|)))))))))
(assert (let ((a!1 (ite (>= (+ (str.len Constructed_Argument) (str.len |0 Fill 1|))
                    (- 1))
                (+ 1 (str.len Constructed_Argument) (str.len |0 Fill 1|))
                0)))
...
(let ((a!3 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) a!2)) 0)
                ...
                (str.substr Constructed_Argument
                            a!2
                            (+ (str.len Constructed_Argument) (* (- 1) a!2))))))
(let ((a!4 (ite (>= (to_real (str.indexof a!3 "]=" 0)) (- 2.0))
                (+ 2.0 (to_real (str.indexof a!3 "]=" 0)))
                (+ 2.0
                   (to_real (str.indexof a!3 "]=" 0))
                   (to_real (str.len a!3))))))
(let ((a!5 (str.substr a!3
                       (to_int a!4)
                       (+ (str.len a!3) (to_int (* (- 1.0) a!4))))))
  (= a!5 "")))))))
(assert (= |5 Fill 0| "+"))
(assert (= |5 Fill 3| "+"))

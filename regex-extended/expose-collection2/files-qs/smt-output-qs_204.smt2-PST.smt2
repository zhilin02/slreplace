...
(assert (let ((a!2 (ite (<= (str.len Constructed_Argument) 0) "" (str.substr Constructed_Argument 0 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) (str.len |0 Fill 1|))) 0) (str.len Constructed_Argument) (str.len |0 Fill 1|)))))) (let ((a!3 (str.substr a!2 0 (ite (>= (str.indexof a!2 "=" 0) 0) (str.indexof a!2 "=" 0) (+ (str.indexof a!2 "=" 0) (str.len a!2)))))) (= (str.in.re (str.++ (ite (<= (str.len a!3) 0) "" (str.substr a!3 0 (ite (>= (+ (str.len |2 Fill 1|) (* (- 1) (str.len a!3))) 0) (str.len a!3) (str.len |2 Fill 1|)))) " " (ite (<= (+ (str.len a!3) (* (- 1) (ite (>= (str.len |2 Fill 1|) (- 1)) (+ 1 (str.len |2 Fill 1|)) (ite (>= (+ (str.len |2 Fill 1|) (str.len a!3)) (- 1)) (+ 1 (str.len |2 Fill 1|) (str.len a!3)) 0)))) 0) "" (str.substr a!3 (ite (>= (str.len |2 Fill 1|) (- 1)) (+ 1 (str.len |2 Fill 1|)) (ite (>= (+ (str.len |2 Fill 1|) (str.len a!3)) (- 1)) (+ 1 (str.len |2 Fill 1|) (str.len a!3)) 0)) (+ (str.len a!3) (* (- 1) (ite (>= (str.len |2 Fill 1|) (- 1)) (+ 1 (str.len |2 Fill 1|)) (ite (>= (+ (str.len |2 Fill 1|) (str.len a!3)) (- 1)) (+ 1 (str.len |2 Fill 1|) (str.len a!3)) 0))))))) (re.++ (re.* (re.range "\x00" "\xff")) (str.to.re "+") (re.* (re.range "\x00" "\xff")))) |IsMatch_/BS+/_3|))))

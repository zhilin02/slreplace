...
(let ((a!7 (str.in.re (str.++ a!2 " " a!6)
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             (str.to.re "+")
                             (re.* (re.range "\x00" "\xff"))))))
  (or (not a!7) (= (str.++ a!2 " " a!6) (str.++ |3 Fill 1| "+" |3 Fill 2|)))))))))
(assert (let ((a!1 (str.substr (str.++ |2 Fill 1| "+" |2 Fill 2|)
                       0
                       (ite (<= (str.len |2 Fill 2|) (- 1))
                            (+ 1 (str.len |2 Fill 1|) (str.len |2 Fill 2|))
...
(let ((a!4 (str.substr (ite (<= (str.len Constructed_Argument) 0)
                       ...
                       (to_int a!3)
                       (+ a!2 (to_int (* (- 1.0) a!3))))))
(let ((a!5 (>= (+ (str.len |2 Fill 1|) (* (- 1) (str.len a!4))) 0))
      (a!7 (ite (>= (+ (str.len |2 Fill 1|) (str.len a!4)) (- 1))
                (+ 1 (str.len |2 Fill 1|) (str.len a!4))
                0)))
(let ((a!6 (ite (<= (str.len a!4) 0)
                ""
                (str.substr a!4 0 (ite a!5 (str.len a!4) (str.len |2 Fill 1|)))))
      (a!8 (ite (>= (str.len |2 Fill 1|) (- 1)) (+ 1 (str.len |2 Fill 1|)) a!7)))
(let ((a!9 (ite (<= (+ (str.len a!4) (* (- 1) a!8)) 0)
                ""
                (str.substr a!4 a!8 (+ (str.len a!4) (* (- 1) a!8))))))
  (str.in.re (str.++ a!6 " " a!9)
             (re.++ (re.* (re.range "\x00" "\xff"))
                    (str.to.re "+")
                    (re.* (re.range "\x00" "\xff")))))))))))

...
(assert (= (to_real (str.indexof (ite (<= (str.len Constructed_Argument) 0) "" (str.substr Constructed_Argument 0 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) (str.len |0 Fill 1|))) 0) (str.len Constructed_Argument) (str.len |0 Fill 1|)))) "=" 0)) (- 1.0)))
(assert (= (str.in.re (ite (<= (str.len Constructed_Argument) 0) "" (str.substr Constructed_Argument 0 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) (str.len |0 Fill 1|))) 0) (str.len Constructed_Argument) (str.len |0 Fill 1|)))) (re.++ (re.* (re.range "\x00" "\xff")) (str.to.re "+") (re.* (re.range "\x00" "\xff")))) |IsMatch_/BS+/_4|))
(assert (not (str.in.re (ite (<= (str.len Constructed_Argument) 0) "" (str.substr Constructed_Argument 0 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) (str.len |0 Fill 1|))) 0) (str.len Constructed_Argument) (str.len |0 Fill 1|)))) (re.++ (re.* (re.range "\x00" "\xff")) (str.to.re "+") (re.* (re.range "\x00" "\xff"))))))
(check-sat)

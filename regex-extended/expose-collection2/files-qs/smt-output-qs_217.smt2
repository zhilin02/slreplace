...
(assert (= |0 Fill 0| "&"))
(assert (= |0 Fill 3| "&"))
(assert (let ((a!1 (str.in.re (str.++ |1 Fill 1| "+" |1 Fill 2|)
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             (str.to.re "&")
                             (re.* (re.range "\x00" "\xff"))))))
  (not a!1)))
(assert (not IsMatch_/&/_0))
(assert (= (to_real (str.indexof (str.++ |1 Fill 1| "+" |1 Fill 2|) "]=" 0)) (- 1.0)))
(assert (= (to_real (str.indexof (str.++ |1 Fill 1| "+" |1 Fill 2|) "=" 0)) (- 1.0)))
(assert (= |1 Fill 0| "+"))
(assert (= |1 Fill 3| "+"))
(assert (= (ite (<= (str.len Constructed_Argument) 0) "" Constructed_Argument)
   (str.++ |1 Fill 1| "+" |1 Fill 2|)))
...
(let ((a!6 (ite (<= (+ (str.len |1 Fill 1|) (str.len |1 Fill 2|) (* (- 1) a!5))
                ...
                (str.substr (str.++ |1 Fill 1| "+" |1 Fill 2|)
                            ...
                            (+ 1
                               ...
                               (str.len |1 Fill 2|)
                               (* (- 1) a!5))))))
  (= (str.++ a!2 " " a!6) (str.++ |2 Fill 1| "+" |2 Fill 2|)))))))
(assert |IsMatch_/\\+/_2|)
...
(let ((a!6 (ite (<= (+ (str.len |1 Fill 1|) (str.len |1 Fill 2|) (* (- 1) a!5))
                ...
                (str.substr (str.++ |1 Fill 1| "+" |1 Fill 2|)
                            ...
                            (+ 1
                               ...
                               (str.len |1 Fill 2|)
                               (* (- 1) a!5))))))
(let ((a!7 (>= (+ (str.len |2 Fill 1|)
                  (* (- 1) (str.len a!2))
                  (* (- 1) (str.len a!6)))
               1))
      (a!10 (ite (>= (+ (str.len |2 Fill 1|) (str.len a!2) (str.len a!6)) (- 2))
                 (+ 2 (str.len |2 Fill 1|) (str.len a!2) (str.len a!6))
                 0)))
(let ((a!8 (str.substr (str.++ |2 Fill 1| "+" |2 Fill 2|)
                       0
                       (ite a!7
                            (+ 1 (str.len a!2) (str.len a!6))
                            (str.len |2 Fill 1|))))
      (a!11 (ite (>= (str.len |2 Fill 1|) (- 1))
                 (+ 1 (str.len |2 Fill 1|))
                 a!10)))
...
(let ((a!13 (str.in.re (str.++ a!9 " " a!12)
                       (re.++ (re.* (re.range "\x00" "\xff"))
                              (str.to.re "+")
                              (re.* (re.range "\x00" "\xff"))))))
  (or (not a!13) (= (str.++ a!9 " " a!12) (str.++ |3 Fill 1| "+" |3 Fill 2|))))))))))))
(assert (let ((a!1 (str.substr (str.++ |1 Fill 1| "+" |1 Fill 2|)
                       0
                       (ite (<= (str.len |1 Fill 2|) (- 1))
                            (+ 1 (str.len |1 Fill 1|) (str.len |1 Fill 2|))
...
(assert (let ((a!1 (str.substr (str.++ |1 Fill 1| "+" |1 Fill 2|)
                       ...
                       (ite (<= (str.len |1 Fill 2|) (- 1))
                            ...
                            (str.len |1 Fill 1|))))
      (a!3 (>= (+ (* 2 (str.len |1 Fill 1|)) (str.len |1 Fill 2|)) (- 2)))
      (a!8 (str.len (ite (<= (str.len Constructed_Argument) 0)
                         ""
                         Constructed_Argument))))
(let ((a!2 (ite (<= (+ (str.len |1 Fill 1|) (str.len |1 Fill 2|)) (- 1))
                0
                (str.len a!1)))
      (a!4 (ite a!3 (+ 2 (* 2 (str.len |1 Fill 1|)) (str.len |1 Fill 2|)) 0))
      (a!9 (ite (>= (+ (str.len |1 Fill 1|) (* (- 1) a!8)) 0)
                a!8
                (str.len |1 Fill 1|)))
      (a!11 (ite (>= (+ (str.len |1 Fill 1|) a!8) (- 1))
                 (+ 1 (str.len |1 Fill 1|) a!8)
                 0)))
(let ((a!5 (ite (>= (str.len |1 Fill 1|) (- 1)) (+ 1 (str.len |1 Fill 1|)) a!4))
      (a!10 (str.substr (ite (<= (str.len Constructed_Argument) 0)
                             ""
                             Constructed_Argument)
                        0
                        a!9))
      (a!12 (ite (>= (str.len |1 Fill 1|) (- 1))
                 (+ 1 (str.len |1 Fill 1|))
                 a!11)))
(let ((a!6 (str.len (str.substr (str.++ |1 Fill 1| "+" |1 Fill 2|)
                                a!5
                                (+ 1
                                   (str.len |1 Fill 1|)
                                   (str.len |1 Fill 2|)
                                   (* (- 1) a!5)))))
      (a!13 (str.substr (ite (<= (str.len Constructed_Argument) 0)
                             ""
                             Constructed_Argument)
                        a!12
                        (+ a!8 (* (- 1) a!12)))))
(let ((a!7 (ite (<= (+ (str.len |1 Fill 1|) (str.len |1 Fill 2|) (* (- 1) a!5))
                    (- 1))
                0
                a!6))
      (a!14 (ite (<= (+ a!8 (* (- 1) a!12)) 0) "" a!13)))
(let ((a!15 (ite (>= (+ (str.len |2 Fill 1|) (* (- 1) a!2) (* (- 1) a!7)) 1)
                 (+ 1 a!2 a!7)
                 (str.len |2 Fill 1|)))
      (a!17 (ite (>= (+ (str.len |2 Fill 1|) a!2 a!7) (- 2))
                 (+ 2 (str.len |2 Fill 1|) a!2 a!7)
                 0)))
(let ((a!16 (str.substr (str.++ (ite (<= a!8 0) "" a!10) " " a!14) 0 a!15))
      (a!18 (ite (>= (str.len |2 Fill 1|) (- 1))
                 (+ 1 (str.len |2 Fill 1|))
                 a!17)))
(let ((a!19 (str.substr (str.++ (ite (<= a!8 0) "" a!10) " " a!14)
                        a!18
                        (+ 1 a!2 a!7 (* (- 1) a!18)))))
(let ((a!20 (ite (<= (+ a!2 a!7 (* (- 1) a!18)) (- 1)) "" a!19)))
(let ((a!21 (str.++ (ite (<= (+ a!2 a!7) (- 1)) "" a!16) " " a!20)))
  (str.in.re a!21
             (re.++ (re.* (re.range "\x00" "\xff"))
                    (str.to.re "+")
                    (re.* (re.range "\x00" "\xff")))))))))))))))

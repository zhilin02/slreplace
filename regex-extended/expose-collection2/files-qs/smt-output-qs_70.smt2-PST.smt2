...
(assert (let ((a!1 (str.len (ite (<= (str.len Constructed_Argument) 0) "" Constructed_Argument)))) (str.in.re (str.++ (ite (<= a!1 0) "" (str.substr (ite (<= (str.len Constructed_Argument) 0) "" Constructed_Argument) 0 (ite (>= (+ (str.len |1 Fill 1|) (* (- 1) a!1)) 0) a!1 (str.len |1 Fill 1|)))) " " (ite (<= (+ a!1 (* (- 1) (ite (>= (str.len |1 Fill 1|) (- 1)) (+ 1 (str.len |1 Fill 1|)) (ite (>= (+ (str.len |1 Fill 1|) a!1) (- 1)) (+ 1 (str.len |1 Fill 1|) a!1) 0)))) 0) "" (str.substr (ite (<= (str.len Constructed_Argument) 0) "" Constructed_Argument) (ite (>= (str.len |1 Fill 1|) (- 1)) (+ 1 (str.len |1 Fill 1|)) (ite (>= (+ (str.len |1 Fill 1|) a!1) (- 1)) (+ 1 (str.len |1 Fill 1|) a!1) 0)) (+ a!1 (* (- 1) (ite (>= (str.len |1 Fill 1|) (- 1)) (+ 1 (str.len |1 Fill 1|)) (ite (>= (+ (str.len |1 Fill 1|) a!1) (- 1)) (+ 1 (str.len |1 Fill 1|) a!1) 0))))))) (re.++ (re.* (re.range "\x00" "\xff")) (str.to.re "+") (re.* (re.range "\x00" "\xff"))))))
(check-sat)

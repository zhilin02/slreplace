...
(let ((a!2 (ite (<= (str.len Constructed_Argument) 0)
                ...
                (str.substr Constructed_Argument
                            ...
                            (ite a!1
                                 (str.len Constructed_Argument)
                                 (str.len |0 Fill 1|))))))
(let ((a!3 (>= (+ (str.len |2 Fill 1|) (* (- 1) (str.len a!2))) 0))
      (a!5 (ite (>= (+ (str.len |2 Fill 1|) (str.len a!2)) (- 1))
                (+ 1 (str.len |2 Fill 1|) (str.len a!2))
                0)))
(let ((a!4 (ite (<= (str.len a!2) 0)
                ""
                (str.substr a!2 0 (ite a!3 (str.len a!2) (str.len |2 Fill 1|)))))
      (a!6 (ite (>= (str.len |2 Fill 1|) (- 1)) (+ 1 (str.len |2 Fill 1|)) a!5)))

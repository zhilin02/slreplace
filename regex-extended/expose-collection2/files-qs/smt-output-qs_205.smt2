...
(let ((a!4 (>= (+ (str.len |2 Fill 1|) (* (- 1) (str.len a!3))) 0))
      (a!6 (ite (>= (+ (str.len |2 Fill 1|) (str.len a!3)) (- 1))
                (+ 1 (str.len |2 Fill 1|) (str.len a!3))
                0)))
(let ((a!5 (ite (<= (str.len a!3) 0)
                ""
                (str.substr a!3 0 (ite a!4 (str.len a!3) (str.len |2 Fill 1|)))))
      (a!7 (ite (>= (str.len |2 Fill 1|) (- 1)) (+ 1 (str.len |2 Fill 1|)) a!6)))
...
(let ((a!9 (str.in.re (str.++ a!5 " " a!8)
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             (str.to.re "+")
                             (re.* (re.range "\x00" "\xff"))))))
  (or (not a!9) (= (str.++ a!5 " " a!8) (str.++ |3 Fill 1| "+" |3 Fill 2|)))))))))))
(assert (let ((a!1 (<= (+ (str.len Constructed_Argument) (* (- 1) (str.len |0 Fill 1|)))
               0)))
(let ((a!2 (ite (<= (str.len Constructed_Argument) 0)
                ""

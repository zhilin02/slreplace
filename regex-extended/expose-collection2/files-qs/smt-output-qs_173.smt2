...
(let ((a!4 (str.substr (ite (<= (str.len Constructed_Argument) 0)
                       ...
                       0
                       a!3)))
(let ((a!5 (>= (+ (str.len |1 Fill 1|) (* (- 1) (str.len a!4))) 0))
      (a!7 (ite (>= (+ (str.len |1 Fill 1|) (str.len a!4)) (- 1))
                (+ 1 (str.len |1 Fill 1|) (str.len a!4))
                0)))
(let ((a!6 (ite (<= (str.len a!4) 0)
                ""
                (str.substr a!4 0 (ite a!5 (str.len a!4) (str.len |1 Fill 1|)))))
      (a!8 (ite (>= (str.len |1 Fill 1|) (- 1)) (+ 1 (str.len |1 Fill 1|)) a!7)))

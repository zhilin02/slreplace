...
(let ((a!4 (str.in.re a!3
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             ...
                             (re.* (re.range "\x00" "\xff"))))))
  (not a!4))))))
(assert (= (to_real (str.indexof (str.++ |3 Fill 1| "+" |3 Fill 2|) "]=" 0)) (- 1.0)))
(assert (= (to_real (str.indexof (str.++ |3 Fill 1| "+" |3 Fill 2|) "=" 0)) (- 1.0)))
(assert (= |3 Fill 0| "+"))
(assert (= |3 Fill 3| "+"))
...
(assert (= |4 Fill 0| "+"))
(assert (= |4 Fill 3| "+"))
(assert (let ((a!1 (str.substr (str.++ |3 Fill 1| "+" |3 Fill 2|)
                       0
                       (ite (<= (str.len |3 Fill 2|) (- 1))
                            (+ 1 (str.len |3 Fill 1|) (str.len |3 Fill 2|))
                            (str.len |3 Fill 1|))))
      (a!3 (>= (+ (* 2 (str.len |3 Fill 1|)) (str.len |3 Fill 2|)) (- 2))))
(let ((a!2 (ite (<= (+ (str.len |3 Fill 1|) (str.len |3 Fill 2|)) (- 1)) "" a!1))
      (a!4 (ite a!3 (+ 2 (* 2 (str.len |3 Fill 1|)) (str.len |3 Fill 2|)) 0)))
(let ((a!5 (ite (>= (str.len |3 Fill 1|) (- 1)) (+ 1 (str.len |3 Fill 1|)) a!4)))
(let ((a!6 (ite (<= (+ (str.len |3 Fill 1|) (str.len |3 Fill 2|) (* (- 1) a!5))
                    (- 1))
                ""
                (str.substr (str.++ |3 Fill 1| "+" |3 Fill 2|)
                            a!5
                            (+ 1
                               (str.len |3 Fill 1|)
                               (str.len |3 Fill 2|)
...
(let ((a!7 (str.in.re (str.++ a!2 " " a!6)
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             (str.to.re "+")
                             (re.* (re.range "\x00" "\xff"))))))
  (or (not a!7) (= (str.++ a!2 " " a!6) (str.++ |4 Fill 1| "+" |4 Fill 2|)))))))))
(assert (let ((a!1 (str.substr (str.++ |3 Fill 1| "+" |3 Fill 2|)
                       0
                       (ite (<= (str.len |3 Fill 2|) (- 1))
                            (+ 1 (str.len |3 Fill 1|) (str.len |3 Fill 2|))
...
(let ((a!2 (ite (<= (str.len Constructed_Argument) 0)
                ...
                (str.substr Constructed_Argument
                            ...
                            (ite a!1
                                 (str.len Constructed_Argument)
                                 (str.len |0 Fill 1|))))))
(let ((a!3 (>= (+ (str.len |3 Fill 1|) (* (- 1) (str.len a!2))) 0))
      (a!5 (ite (>= (+ (str.len |3 Fill 1|) (str.len a!2)) (- 1))
                (+ 1 (str.len |3 Fill 1|) (str.len a!2))
                0)))
(let ((a!4 (ite (<= (str.len a!2) 0)
                ""
                (str.substr a!2 0 (ite a!3 (str.len a!2) (str.len |3 Fill 1|)))))
      (a!6 (ite (>= (str.len |3 Fill 1|) (- 1)) (+ 1 (str.len |3 Fill 1|)) a!5)))
(let ((a!7 (ite (<= (+ (str.len a!2) (* (- 1) a!6)) 0)
                ""
                (str.substr a!2 a!6 (+ (str.len a!2) (* (- 1) a!6))))))
  (str.in.re (str.++ a!4 " " a!7)
             (re.++ (re.* (re.range "\x00" "\xff"))
                    (str.to.re "+")
                    (re.* (re.range "\x00" "\xff"))))))))))

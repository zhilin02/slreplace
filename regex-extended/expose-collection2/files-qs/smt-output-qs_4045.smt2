...
(assert (let ((a!1 (ite (>= (+ (str.len Constructed_Argument)
                       (str.len |0 Fill 1|)
                       (str.len |1 Fill 1|))
                    (- 2))
                (+ 2
                   ...
                   (str.len |1 Fill 1|))
                0)))
(let ((a!2 (ite (>= (+ (str.len |0 Fill 1|) (str.len |1 Fill 1|)) (- 2))
                (+ 2 (str.len |0 Fill 1|) (str.len |1 Fill 1|))
                a!1)))
(let ((a!3 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) a!2)) 0)
                ""
                (str.substr Constructed_Argument
...
(let ((a!2 (ite (<= (str.len Constructed_Argument) 0)
                ...
                (str.substr Constructed_Argument
                            ...
                            (ite a!1
                                 (str.len Constructed_Argument)
                                 (str.len |0 Fill 1|))))))
(let ((a!3 (str.substr a!2
                       0
                       (ite (>= (str.indexof a!2 "=" 0) 0)
                            (str.indexof a!2 "=" 0)
                            (+ (str.indexof a!2 "=" 0) (str.len a!2))))))
(let ((a!4 (>= (+ (str.len |3 Fill 1|) (* (- 1) (str.len a!3))) 0))
      (a!6 (ite (>= (+ (str.len |3 Fill 1|) (str.len a!3)) (- 1))
                (+ 1 (str.len |3 Fill 1|) (str.len a!3))
                0)))
(let ((a!5 (ite (<= (str.len a!3) 0)
                ""
                (str.substr a!3 0 (ite a!4 (str.len a!3) (str.len |3 Fill 1|)))))
      (a!7 (ite (>= (str.len |3 Fill 1|) (- 1)) (+ 1 (str.len |3 Fill 1|)) a!6)))
(let ((a!8 (ite (<= (+ (str.len a!3) (* (- 1) a!7)) 0)
                ""
                (str.substr a!3 a!7 (+ (str.len a!3) (* (- 1) a!7))))))
(let ((a!9 (str.in.re (str.++ a!5 " " a!8)
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             (str.to.re "+")
                             (re.* (re.range "\x00" "\xff"))))))
  (or (not a!9) (= (str.++ a!5 " " a!8) (str.++ |4 Fill 1| "+" |4 Fill 2|)))))))))))
(assert (let ((a!1 (<= (+ (str.len Constructed_Argument) (* (- 1) (str.len |0 Fill 1|)))
               0)))
(let ((a!2 (ite (<= (str.len Constructed_Argument) 0)
                ""

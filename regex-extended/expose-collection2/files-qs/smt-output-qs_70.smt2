...
(let ((a!7 (str.in.re (str.++ a!2 " " a!6)
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             ...
                             (re.* (re.range "\x00" "\xff"))))))
  (= a!7 |IsMatch_/\\+/_2|)))))))
(assert (let ((a!1 (str.len (ite (<= (str.len Constructed_Argument) 0)
                         ""
                         Constructed_Argument))))
(let ((a!2 (ite (>= (+ (str.len |1 Fill 1|) (* (- 1) a!1)) 0)
                a!1
                (str.len |1 Fill 1|)))
      (a!4 (ite (>= (+ (str.len |1 Fill 1|) a!1) (- 1))
                (+ 1 (str.len |1 Fill 1|) a!1)
                0)))
(let ((a!3 (str.substr (ite (<= (str.len Constructed_Argument) 0)
                       ...
                       0
                       a!2))
      (a!5 (ite (>= (str.len |1 Fill 1|) (- 1)) (+ 1 (str.len |1 Fill 1|)) a!4)))
(let ((a!6 (str.substr (ite (<= (str.len Constructed_Argument) 0)
                            ""
                            Constructed_Argument)
                       a!5
                       (+ a!1 (* (- 1) a!5)))))
(let ((a!7 (ite (<= (+ a!1 (* (- 1) a!5)) 0) "" a!6)))
  (str.in.re (str.++ (ite (<= a!1 0) "" a!3) " " a!7)
             (re.++ (re.* (re.range "\x00" "\xff"))
                    (str.to.re "+")
                    (re.* (re.range "\x00" "\xff"))))))))))

...
(let ((a!5 (ite (>= (to_real (str.indexof a!2 "]=" 0)) (- 1.0))
  ...
  (= (str.substr a!2 0 (to_int a!5)) (str.++ |2 Fill 1| "+" |2 Fill 2|)))))))
(assert |IsMatch_/\\+/_2|)
...
(let ((a!3 (ite (>= (to_real (str.indexof a!2 "]=" 0)) (- 1.0))
                ...
                (+ 1.0
                   ...
                   (to_real (str.len a!2))))))
(let ((a!4 (<= (str.len (str.substr a!2 0 (to_int a!3))) 0))
      (a!5 (* (- 1) (str.len (str.substr a!2 0 (to_int a!3)))))
      (a!8 (+ (str.len |2 Fill 1|) (str.len (str.substr a!2 0 (to_int a!3)))))
      (a!9 (+ 1 (str.len |2 Fill 1|) (str.len (str.substr a!2 0 (to_int a!3))))))
(let ((a!6 (ite (>= (+ (str.len |2 Fill 1|) a!5) 0)
                (str.len (str.substr a!2 0 (to_int a!3)))
                (str.len |2 Fill 1|)))
      (a!10 (ite (>= (str.len |2 Fill 1|) (- 1))
                 (+ 1 (str.len |2 Fill 1|))
                 (ite (>= a!8 (- 1)) a!9 0))))
(let ((a!7 (ite a!4 "" (str.substr (str.substr a!2 0 (to_int a!3)) 0 a!6)))
      (a!11 (+ (str.len (str.substr a!2 0 (to_int a!3))) (* (- 1) a!10))))
(let ((a!12 (ite (<= a!11 0)
                 ""
                 (str.substr (str.substr a!2 0 (to_int a!3)) a!10 a!11))))
(let ((a!13 (str.in.re (str.++ a!7 " " a!12)
                       (re.++ (re.* (re.range "\x00" "\xff"))
                              (str.to.re "+")
                              (re.* (re.range "\x00" "\xff"))))))
  (or (not a!13) (= (str.++ a!7 " " a!12) (str.++ |3 Fill 1| "+" |3 Fill 2|))))))))))))
(assert (let ((a!1 (<= (+ (str.len Constructed_Argument) (* (- 1) (str.len |0 Fill 1|)))
               0)))
(let ((a!2 (ite (<= (str.len Constructed_Argument) 0)
                ""

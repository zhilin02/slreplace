...
(assert (= (str.in.re replace_0_0 (re.++ (re.* (re.range "\x00" "\xff")) (str.to.re "\x1B[") (re.range "0" "9") (re.* (re.range "0" "9")) (str.to.re "m") (re.* (re.range "\x00" "\xff")))) |IsMatch_/BSx1BBS[BSd+m/_1|))
(assert (not |IsMatch_/BSx1BBS[BSd+m/_1|))
(assert (<= (+ (to_real (str.len |0 Fill 4|)) (to_real (str.len |0 Fill 5|))) 0.0))

...
(assert (let ((a!2 |0 Fill 4|)) (let ((a!5 |0 Fill 5|)) (str.in.re (str.++ (ite (<= (+ (str.len a!2) (str.len a!5)) 0) "" (str.substr (str.++ a!2 a!5) 0 (ite (>= (+ (str.len |1 Fill 4|) (* (- 1) (str.len a!2)) (* (- 1) (str.len a!5))) 0) (+ (str.len a!2) (str.len a!5)) (str.len |1 Fill 4|)))) (ite (<= (+ (str.len a!2) (str.len a!5) (* (- 1) (ite (>= (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|)) 0) (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|)) (ite (>= (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|) (str.len a!2) (str.len a!5)) 0) (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|) (str.len a!2) (str.len a!5)) 0)))) 0) "" (str.substr (str.++ a!2 a!5) (ite (>= (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|)) 0) (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|)) (ite (>= (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|) (str.len a!2) (str.len a!5)) 0) (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|) (str.len a!2) (str.len a!5)) 0)) (+ (str.len a!2) (str.len a!5) (* (- 1) (ite (>= (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|)) 0) (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|)) (ite (>= (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|) (str.len a!2) (str.len a!5)) 0) (+ (str.len |1 Fill 4|) (str.len |1 Fill 6|) (str.len a!2) (str.len a!5)) 0))))))) (re.++ (re.* (re.range "\x00" "\xff")) (str.to.re "\x1B[") (re.range "0" "9") (re.* (re.range "0" "9")) (str.to.re "m") (re.* (re.range "\x00" "\xff")))))))
(assert (not (= Constructed_Argument "\x1B[9mm\x1B[\x1B[18m591m")))
(check-sat)

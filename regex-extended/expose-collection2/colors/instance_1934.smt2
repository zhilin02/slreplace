...
(assert (= |1 Fill 3| "m"))
(assert (str.in.re (str.++ "\x1B[" |1 Fill 2| "m")
           (re.++ (str.to.re "\x1B[")
                  (re.range "0" "9")
                  (re.* (re.range "0" "9"))
                  (str.to.re "m"))))
...
(let ((a!6 (str.in.re (str.++ a!2 a!5)
                      (re.++ (re.* (re.range "\x00" "\xff"))
                             ...
                             (str.to.re "m")
                             (re.* (re.range "\x00" "\xff"))))))
  (or (not a!6) (= (str.++ a!2 a!5) (str.++ |1 Fill 4| |1 Fill 6| |1 Fill 5|))))))))
(assert (let ((a!1 (>= (+ (str.len |0 Fill 4|) (* (- 1) (str.len Constructed_Argument)))
               0))
      (a!3 (ite (>= (+ (str.len |0 Fill 4|)
                       (str.len |0 Fill 6|)
...
(let ((a!3 (ite (<= (+ (str.len Constructed_Argument) (* (- 1) a!2)) 0)
  ...
  (<= (+ (to_real (str.len a!3)) (to_real (str.len a!5))) 0.0)))))

...
(let ((a!8 (ite (<= (+ (str.len a!2) (str.len a!5)) 0) "" a!7))
      (a!11 (ite (<= (+ (str.len a!2) (* (- 1) a!10) (str.len a!5)) 0)
                 ""
                 (str.substr (str.++ |1 Fill 4|
                                     "\x1B["
                                     |1 Fill 2|
                                     ...
                                     |1 Fill 5|)
                             a!10
                             (+ (str.len a!2) (* (- 1) a!10) (str.len a!5))))))
  (<= (+ (to_real (str.len a!8)) (to_real (str.len a!11))) 1.0))))))))
(assert CreateAsClass_2)
(assert (not (= Constructed_Argument "\x1B[55m5\x1B[4m")))

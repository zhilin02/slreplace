...
(declare-fun Constructed_Argument_elements_isTTY_0 () Bool)
...
(assert (= Constructed_Argument_elements_isTTY_0_t "boolean"))
(assert (not Constructed_Argument_elements_isTTY_0))

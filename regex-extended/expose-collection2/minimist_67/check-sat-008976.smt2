...
(let ((a!3 (ite (>= (+ (str.len |3 Fill 1|) (str.len |3 Fill 0|)) 0)
                (+ (str.len |3 Fill 1|) (str.len |3 Fill 0|))
                a!2)))
(let ((a!5 (str.in.re (str.substr |2 Fill 3|
                                  (+ (str.len |3 Fill 1|) (str.len |3 Fill 0|))
                                  (+ (str.len |2 Fill 3|) (* (- 1) a!3)))
                      a!4)))
  (or a!1 a!5)))))
...
(let ((a!4 (str.substr |2 Fill 3|
      ...
      (a!6 (str.in.re (str.substr |2 Fill 3| 0 (+ (str.len |2 Fill 3|) a!3))
                      a!5))
      (a!8 (ite (>= a!2 0)
                ""
                (str.substr |2 Fill 3| 0 (+ (str.len |2 Fill 3|) a!3)))))
(let ((a!7 (ite a!1 (str.in.re a!4 a!5) (not (or (>= a!2 0) (not a!6)))))
      (a!9 (ite (<= (+ (str.len |2 Fill 3|) a!3) 0) "" (ite a!1 a!4 a!8))))
  (or (<= (+ (str.len |2 Fill 3|) a!3) 0)
      (not a!7)
...
(let ((a!2 (ite (>= (+ (str.len |3 Fill 1|)
                ...
                (+ (str.len |3 Fill 1|)
                   ...
                   (str.len |4 Fill 0|))
                (ite (>= a!1 0) a!1 0))))
(let ((a!3 (not (<= (+ (str.len |2 Fill 3|) (* (- 1) a!2)) 0)))

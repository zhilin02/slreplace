...
(define-funs-rec ((MatchTD_0_1main ((x String) (y String)) Bool) (MatchTD_0_1s0a ((x String) (y String)) Bool) (MatchTD_0_1s1a ((x String) (y String)) Bool) (MatchTD_0_1s2a ((x String) (y String)) Bool) (MatchTD_0_1s3a ((x String) (y String)) Bool) (MatchTD_0_1s4a ((x String) (y String)) Bool) (MatchTD_0_1s5a ((x String) (y String)) Bool) (MatchTD_0_1s7a ((x String) (y String)) Bool) (MatchTD_0_1s6a ((x String) (y String)) Bool) (MatchTD_0_1s6aWildos6a ((x String) (y String)) Bool) (MatchTD_0_1s6aemptyos7a ((x String) (y String)) Bool)) ((MatchTD_0_1s0a x y) (and (not (= x "")) (= (str.head_code x) (str.to_code "-")) (MatchTD_0_1s1a (str.tail x) y)) (and (not (= x "")) (= (str.head_code x) (str.to_code "-")) (MatchTD_0_1s2a (str.tail x) y)) (and (not (= x "")) (= (str.head_code x) (str.to_code "n")) (MatchTD_0_1s3a (str.tail x) y)) (and (not (= x "")) (= (str.head_code x) (str.to_code "o")) (MatchTD_0_1s4a (str.tail x) y)) (and (not (= x "")) (= (str.head_code x) (str.to_code "-")) (MatchTD_0_1s5a (str.tail x) y)) (and (not (= x "")) (MatchTD_0_1s6a (str.tail x) y)) (or (and (= x "") (= y ""))) (or (MatchTD_0_1s6aWildos6a x y) (and (not (exists ((z String)) (MatchTD_0_1s6aWildos6a x z))) (MatchTD_0_1s6aemptyos7a x y))) (and (not (= x "")) (MatchTD_0_1s6a (str.tail x) y)) (MatchTD_0_1s7a x y)))
...
(assert (= (ite (>= (+ (str.len |3 Fill 1|) (* (- 1) (str.len |2 Fill 3|))) 0) |2 Fill 3| (str.substr |2 Fill 3| 0 (str.len |3 Fill 1|))) (str.++ (seq.unit #x5f) (seq.unit #x5f) (seq.unit #x70) (seq.unit #x72) (seq.unit #x6f) (seq.unit #x74) (seq.unit #x6f) (seq.unit #x5f) (seq.unit #x5f))))
(assert (= |1 Fill 5| (str.++ (seq.unit #x2d) (seq.unit #x2d) (seq.unit #x6e) (seq.unit #x6f) (seq.unit #x2d) (seq.unit #x5f) (seq.unit #x5f) (seq.unit #x70) (seq.unit #x72) (seq.unit #x6f) (seq.unit #x74) (seq.unit #x6f) (seq.unit #x5f) (seq.unit #x5f) (seq.unit #x0b) (seq.unit #x2b))))
(check-sat)

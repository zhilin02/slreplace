...
(assert (str.in.re (str.at Constructed_Argument 5) (re.++ (str.to.re (str.++ (seq.unit #x2d) (seq.unit #x2d))) (re.union (re.range (seq.unit #x0b) (seq.unit #xff)) (re.range (seq.unit #x00) (seq.unit #x09))) (re.* (re.union (re.range (seq.unit #x0b) (seq.unit #xff)) (re.range (seq.unit #x00) (seq.unit #x09)))) (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
(check-sat)

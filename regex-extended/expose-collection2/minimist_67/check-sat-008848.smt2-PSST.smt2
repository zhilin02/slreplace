...
(assert (not (= (to_real (str.indexof Constructed_Argument (str.++ (seq.unit #x2d) (seq.unit #x2d)) 0)) (- 1.0))))
(assert (not (<= (to_real (str.len (str.substr Constructed_Argument 0 (ite (>= (str.indexof Constructed_Argument (str.++ (seq.unit #x2d) (seq.unit #x2d)) 0) 0) (str.indexof Constructed_Argument (str.++ (seq.unit #x2d) (seq.unit #x2d)) 0) (+ (str.len Constructed_Argument) (str.indexof Constructed_Argument (str.++ (seq.unit #x2d) (seq.unit #x2d)) 0)))))) 0.0)))
(check-sat)

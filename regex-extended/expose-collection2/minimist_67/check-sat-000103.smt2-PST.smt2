...
(assert (str.in.re (select Constructed_Argument 0) (re.++ (str.to.re (str.++ (seq.unit #x2d) (seq.unit #x2d))) (re.union (re.range (seq.unit #x0b) (seq.unit #xff)) (re.range (seq.unit #x00) (seq.unit #x09))) (re.* (re.union (re.range (seq.unit #x0b) (seq.unit #xff)) (re.range (seq.unit #x00) (seq.unit #x09)))) (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
(assert (= |2 Fill 4| (str.++ (seq.unit #x2d) (seq.unit #x2d) (seq.unit #x5c) (seq.unit #x75) (seq.unit #x7b) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x63) (seq.unit #x33) (seq.unit #x7d) (seq.unit #x5c) (seq.unit #x75) (seq.unit #x7b) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x61) (seq.unit #x62) (seq.unit #x7d) (seq.unit #x08))))
(check-sat)

...
(assert (>= (str.len (select Constructed_Argument 1)) 1))
(assert (= (str.substr (select Constructed_Argument 1) 0 1) (seq.unit #x2d)))
(assert (str.in.re (str.substr (select Constructed_Argument 1) 1 (+ (- 1) (str.len (select Constructed_Argument 1)))) (re.* (re.range (seq.unit #x00) (seq.unit #xff)))))
(check-sat)

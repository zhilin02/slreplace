...
(assert IsMatch_/^--.+/_2)
(assert |IsMatch_/^--(.+)/_3|)
(assert (not (str.in.re (select Constructed_Argument 0) (re.++ (str.to.re (str.++ (seq.unit #x2d) (seq.unit #x2d))) (re.union (re.range (seq.unit #x00) (seq.unit #x09)) (re.range (seq.unit #x0b) (seq.unit #xff))) (re.* (re.union (re.range (seq.unit #x00) (seq.unit #x09)) (re.range (seq.unit #x0b) (seq.unit #xff)))) (re.* (re.range (seq.unit #x00) (seq.unit #xff)))))))
(check-sat)

...
(let ((a!5 (re.++ (re.union (str.to.re (seq.unit #x2d))
  ...
  (str.in.re (str.++ |3 Fill 6| |3 Fill 11| |3 Fill 10|) a!5)))))
...
(let ((a!5 (re.++ (re.union (str.to.re (seq.unit #x2d))
                  ...
                  a!3
                  (re.union (str.to.re "") a!4))))
  (or (not (str.in.re |1 Fill 4| a!5)) (= |1 Fill 4| |3 Fill 12|))))))
(assert (let ((a!1 (re.++ (re.range (seq.unit #x30) (seq.unit #x39))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))
      (a!2 (re.++ (str.to.re (seq.unit #x2e))
                  (re.* (re.range (seq.unit #x30) (seq.unit #x39))))))
...
(assert (let ((a!1 (re.++ (re.* (re.range (seq.unit #x00) (seq.unit #xff)))
  ...
  (or (= (str.len |1 Fill 2|) 0) (not (str.in.re |1 Fill 2| a!1)) a!2)))
(assert (let ((a!1 (re.++ (re.* (re.range (seq.unit #x00) (seq.unit #xff)))
                  (re.union (re.range (seq.unit #x00) (seq.unit #x09))
                            (re.range (seq.unit #x0b) (seq.unit #xff)))
                  (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
(let ((a!2 (not (or (= (str.len |1 Fill 2|) 0) (not (str.in.re |1 Fill 2| a!1))))))
  (= a!2 IsMatch_/./_4))))
...
(let ((a!3 (str.substr |1 Fill 2|
      ...
      (a!5 (str.in.re (str.substr |1 Fill 2|
                                  0
                                  (+ (str.len |1 Fill 2|) (* (- 1) a!2)))
                      a!4))

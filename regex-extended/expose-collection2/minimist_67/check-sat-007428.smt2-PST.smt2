...
(assert (str.in.re (str.at Constructed_Argument 5) (re.++ (str.to.re (str.++ (seq.unit #x30) (seq.unit #x78))) (re.union (re.range (seq.unit #x30) (seq.unit #x39)) (re.range (seq.unit #x61) (seq.unit #x66))) (re.* (re.union (re.range (seq.unit #x30) (seq.unit #x39)) (re.range (seq.unit #x61) (seq.unit #x66)))))))
(check-sat)

...
(assert (str.in.re (select Constructed_Argument 1) (re.++ (re.union (str.to.re (seq.unit #x2d)) (str.to.re "") (str.to.re (seq.unit #x2b))) (re.union (re.++ (re.++ (re.range (seq.unit #x30) (seq.unit #x39)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))) (re.union (str.to.re "") (re.++ (str.to.re (seq.unit #x2e)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))) (re.++ (str.to.re (seq.unit #x2e)) (re.++ (re.range (seq.unit #x30) (seq.unit #x39)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))) (re.union (str.to.re "") (re.++ (str.to.re (seq.unit #x65)) (re.union (str.to.re (seq.unit #x2d)) (str.to.re "") (str.to.re (seq.unit #x2b))) (re.++ (re.range (seq.unit #x30) (seq.unit #x39)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))))))
(assert (not (= (select Constructed_Argument 0) (str.++ (seq.unit #x2d) (seq.unit #x2d) (seq.unit #x6c) (seq.unit #x5c) (seq.unit #x75) (seq.unit #x7b) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x63) (seq.unit #x33) (seq.unit #x7d) (seq.unit #x5c) (seq.unit #x75) (seq.unit #x7b) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x66) (seq.unit #x38) (seq.unit #x37) (seq.unit #x7d)))))
(check-sat)

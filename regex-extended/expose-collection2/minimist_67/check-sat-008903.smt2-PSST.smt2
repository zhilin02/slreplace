...
(assert (not (str.in.re |4 Fill 2| (re.++ (str.to.re (str.++ (seq.unit #x2d) (seq.unit #x2d))) (re.union (re.range (seq.unit #x00) (seq.unit #x09)) (re.range (seq.unit #x0b) (seq.unit #xff))) (re.* (re.union (re.range (seq.unit #x00) (seq.unit #x09)) (re.range (seq.unit #x0b) (seq.unit #xff)))) (str.to.re (seq.unit #x3d)) (re.* (re.range (seq.unit #x00) (seq.unit #xff)))))))
(assert (not IsMatch_/^--.+=/_0))
(assert (not (str.in.re |4 Fill 2| (re.++ (str.to.re (str.++ (seq.unit #x2d) (seq.unit #x2d) (seq.unit #x6e) (seq.unit #x6f) (seq.unit #x2d))) (re.union (re.range (seq.unit #x00) (seq.unit #x09)) (re.range (seq.unit #x0b) (seq.unit #xff))) (re.* (re.union (re.range (seq.unit #x00) (seq.unit #x09)) (re.range (seq.unit #x0b) (seq.unit #xff)))) (re.* (re.range (seq.unit #x00) (seq.unit #xff)))))))
(assert (not IsMatch_/^--no-.+/_1))
(assert (not (str.in.re |4 Fill 2| (re.++ (str.to.re (str.++ (seq.unit #x2d) (seq.unit #x2d))) (re.union (re.range (seq.unit #x00) (seq.unit #x09)) (re.range (seq.unit #x0b) (seq.unit #xff))) (re.* (re.union (re.range (seq.unit #x00) (seq.unit #x09)) (re.range (seq.unit #x0b) (seq.unit #xff)))) (re.* (re.range (seq.unit #x00) (seq.unit #xff)))))))
(assert (not IsMatch_/^--.+/_2))
(assert (not (str.in.re |4 Fill 2| (re.++ (str.to.re (seq.unit #x2d)) (re.inter (re.comp (str.to.re (seq.unit #x2d))) (re.range (seq.unit #x00) (seq.unit #xff))) (re.* (re.inter (re.comp (str.to.re (seq.unit #x2d))) (re.range (seq.unit #x00) (seq.unit #xff)))) (re.* (re.range (seq.unit #x00) (seq.unit #xff)))))))
(assert (not |IsMatch_/^-[^-]+/_3|))
(assert (= |4 Fill 0| (str.++ (seq.unit #x30) (seq.unit #x78))))
(assert (str.in.re |4 Fill 1| (re.++ (re.union (re.range (seq.unit #x30) (seq.unit #x39)) (re.range (seq.unit #x61) (seq.unit #x66))) (re.* (re.union (re.range (seq.unit #x30) (seq.unit #x39)) (re.range (seq.unit #x61) (seq.unit #x66)))))))
(assert (= |4 Fill 2| (select Constructed_Argument 0)))
(assert (= |4 Fill 2| (str.++ (seq.unit #x30) (seq.unit #x78) |4 Fill 1|)))
(assert (str.in.re |4 Fill 2| (re.++ (str.to.re (str.++ (seq.unit #x30) (seq.unit #x78))) (re.union (re.range (seq.unit #x30) (seq.unit #x39)) (re.range (seq.unit #x61) (seq.unit #x66))) (re.* (re.union (re.range (seq.unit #x30) (seq.unit #x39)) (re.range (seq.unit #x61) (seq.unit #x66)))))))

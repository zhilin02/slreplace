...
(assert (= (str.in.re (select Constructed_Argument 0) (re.++ (str.to.re (str.++ (seq.unit #x30) (seq.unit #x78))) (re.union (re.range (seq.unit #x30) (seq.unit #x39)) (re.range (seq.unit #x61) (seq.unit #x66))) (re.* (re.union (re.range (seq.unit #x30) (seq.unit #x39)) (re.range (seq.unit #x61) (seq.unit #x66)))))) |IsMatch_/^0x[0-9a-f]+$/i_4|))
(assert (not |IsMatch_/^0x[0-9a-f]+$/i_4|))
(assert (= (str.in.re (select Constructed_Argument 0) (re.++ (re.union (str.to.re (seq.unit #x2d)) (str.to.re "") (str.to.re (seq.unit #x2b))) (re.union (re.++ (re.++ (re.range (seq.unit #x30) (seq.unit #x39)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))) (re.union (str.to.re "") (re.++ (str.to.re (seq.unit #x2e)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))) (re.++ (str.to.re (seq.unit #x2e)) (re.++ (re.range (seq.unit #x30) (seq.unit #x39)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))) (re.union (str.to.re "") (re.++ (str.to.re (seq.unit #x65)) (re.union (str.to.re (seq.unit #x2d)) (str.to.re "") (str.to.re (seq.unit #x2b))) (re.++ (re.range (seq.unit #x30) (seq.unit #x39)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))))) |IsMatch_/^[-+]?(?:BSd+(?:BS.BSd*)?STBS.BSd+)(e[-+]?BSd+)?$/_5|))
(assert (str.in.re (select Constructed_Argument 0) (re.++ (re.union (str.to.re (seq.unit #x2d)) (str.to.re "") (str.to.re (seq.unit #x2b))) (re.union (re.++ (re.++ (re.range (seq.unit #x30) (seq.unit #x39)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))) (re.union (str.to.re "") (re.++ (str.to.re (seq.unit #x2e)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))) (re.++ (str.to.re (seq.unit #x2e)) (re.++ (re.range (seq.unit #x30) (seq.unit #x39)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))) (re.union (str.to.re "") (re.++ (str.to.re (seq.unit #x65)) (re.union (str.to.re (seq.unit #x2d)) (str.to.re "") (str.to.re (seq.unit #x2b))) (re.++ (re.range (seq.unit #x30) (seq.unit #x39)) (re.* (re.range (seq.unit #x30) (seq.unit #x39)))))))))
(check-sat)

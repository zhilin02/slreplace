...
(assert (str.in.re (str.at Constructed_Argument 2) (re.++ (str.to.re (seq.unit #x2d)) (re.inter (re.comp (str.to.re (seq.unit #x2d))) (re.range (seq.unit #x00) (seq.unit #xff))) (re.* (re.inter (re.comp (str.to.re (seq.unit #x2d))) (re.range (seq.unit #x00) (seq.unit #xff)))) (re.* (re.range (seq.unit #x00) (seq.unit #xff))))))
(check-sat)

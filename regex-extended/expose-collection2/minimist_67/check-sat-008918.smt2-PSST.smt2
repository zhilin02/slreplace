...
(assert (let ((a!1 (+ (str.len |4 Fill 1|) (str.len |5 Fill 1|) (str.len |3 Fill 2|) (str.len |4 Fill 0|) (str.len |5 Fill 0|)))) (not (and (not (<= (+ (str.len |3 Fill 2|) (* (- 1) (ite (>= (+ (str.len |4 Fill 1|) (str.len |5 Fill 1|) (str.len |4 Fill 0|) (str.len |5 Fill 0|)) 0) (+ (str.len |4 Fill 1|) (str.len |5 Fill 1|) (str.len |4 Fill 0|) (str.len |5 Fill 0|)) (ite (>= a!1 0) a!1 0)))) 0)) (str.in.re (str.substr |3 Fill 2| (ite (>= (+ (str.len |4 Fill 1|) (str.len |5 Fill 1|) (str.len |4 Fill 0|) (str.len |5 Fill 0|)) 0) (+ (str.len |4 Fill 1|) (str.len |5 Fill 1|) (str.len |4 Fill 0|) (str.len |5 Fill 0|)) (ite (>= a!1 0) a!1 0)) (+ (str.len |3 Fill 2|) (* (- 1) (ite (>= (+ (str.len |4 Fill 1|) (str.len |5 Fill 1|) (str.len |4 Fill 0|) (str.len |5 Fill 0|)) 0) (+ (str.len |4 Fill 1|) (str.len |5 Fill 1|) (str.len |4 Fill 0|) (str.len |5 Fill 0|)) (ite (>= a!1 0) a!1 0))))) (re.++ (re.* (re.range (seq.unit #x00) (seq.unit #xff))) (re.union (re.range (seq.unit #x00) (seq.unit #x09)) (re.range (seq.unit #x0b) (seq.unit #xff))) (re.* (re.range (seq.unit #x00) (seq.unit #xff)))))))))
(assert (not (= (select Constructed_Argument 0) (str.++ (seq.unit #x2d) (seq.unit #x2d) (seq.unit #x6e) (seq.unit #x0d)))))
(check-sat)

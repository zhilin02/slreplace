...
(assert (let ((a!1 (to_real (str.indexof Constructed_Argument
                                 ...
                                 0))))
  (not (= a!1 (- 1.0)))))
(assert (let ((a!1 (>= (str.indexof Constructed_Argument
                            (str.++ (seq.unit #x2d) (seq.unit #x2d))
                            0)
               0))
      (a!2 (+ (str.len Constructed_Argument)
              (str.indexof Constructed_Argument
                           (str.++ (seq.unit #x2d) (seq.unit #x2d))
                           0))))
(let ((a!3 (ite a!1
                (str.indexof Constructed_Argument
                             ...
                             0)
                a!2)))
(let ((a!4 (<= (to_real (str.len (str.substr Constructed_Argument 0 a!3))) 0.0)))
  (not a!4)))))

...
(declare-fun Constructed_Argument_2_elements__name_1_elements_forEach_0_t
             ()
             String)
...
(assert (= Constructed_Argument_2_elements__name_1_t
   (str.++ (seq.unit #x6f)
           ...
           (seq.unit #x63)
           (seq.unit #x74))))
(assert (not (= Constructed_Argument_2_elements__name_1_elements_forEach_0_t
        (str.++ (seq.unit #x73)
                (seq.unit #x74)
                (seq.unit #x72)
                (seq.unit #x69)
...
(assert (not (= Constructed_Argument_2_elements__name_1_elements_forEach_0_t
        (str.++ (seq.unit #x6e)
                ...
                (seq.unit #x65)
                (seq.unit #x72)))))
(assert (= Constructed_Argument_2_elements__name_1_elements_forEach_0_t
   (str.++ (seq.unit #x62)
           (seq.unit #x6f)
           (seq.unit #x6f)
           (seq.unit #x6c)

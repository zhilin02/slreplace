...
In this section, we restrict the form of the assertion $\ASSERT{x \in e}$ such that $e$ is a regular expression \emph{without} capturing groups and back references.

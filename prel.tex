...
\mat{If we cite this, don't we also need that NFA are closed under boolean operations, since we use it often?}
...
classes (see \cite{HU79} for more details): P (problems solvable

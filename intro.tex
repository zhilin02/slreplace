...
The general forms of the $\replaceall$ function, in particular, the forms of the $\replaceall$ function where the replacement parameter is a variable, are indeed used in the programs from the practice.  

...
\anthony{I think the following example should appear earlier no? Perhaps
after Matt mentioned about Mustache? We need to get
the reader to be convinced first that general replaceall is useful.}

...
the formulas. Nonetheless, as was already noted in \cite{LB16},
...
into a Static Single Assignment (SSA) form (i.e. by introducing a new variable 
...
above
grammar is either a concatenation of string variables, or 
the $\replaceall$ function where \emph{the 
pattern and the replacement are both string constants}, and (2) $g$ is
a boolean combination of regular constraints (e.g. given by regular
expressions).
...
The decidability boundary of the straight-line fragment of string

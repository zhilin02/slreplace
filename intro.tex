...
Another frequently used string operation (especially, in popular scripting
languages like Python, JavaScript, and PHP) is the string-replace function, 
which may be used either to replace either the first occurrence or to replace 
...
string by \verb+\'+ and \verb+\"+. These can typically be expressed by
(perhaps multiple) applications of the string-replace function. Notice,
however, that this \emph{cannot} be expressed using the theory of concatenation 
with regular constraints alone.

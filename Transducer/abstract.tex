...
%logics for reasoning about symbolic executions of programs with strings. 
    ...
    those functions that are crucial for such an application as 
    ...
    generalises the standard finite-state transducer model and capture the three
    ...
    and provide a precise computational complexity analysis. The logic is
    ...
    to the world of symbolic finite automata/transducers, which is required for

...
\newcommand\rcphi{\mathsf{fsize}}
\newcommand\rcpsi{\mathsf{rsize}}
...
\newcommand{\sizetrans}{\mathsf{TS}}


\newcommand{\prerec}{\textsf{PreRec}}

%%%%%%%%%%%%
% Auto escape eg

\newcommand\linkvar{\mintinline{html}{$link}}
\newcommand\linktextvar{\mintinline{html}{$linkText}}

...
In this section, we consider an extension of parametric transducers to infinite data domains \tl{maybe not emphasise infinite domain}, called \emph{symbolic parametric transducers}, where the input letters are replaced by formulae over an infinite data domain and the output letters are replaced by terms. 
%

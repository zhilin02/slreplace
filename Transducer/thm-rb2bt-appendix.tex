...
\section{Proof of Theorem~\ref{cor-s2pt}: EXPSPACE upper bound for \PT{}s, replaceall, concatenation, and reverse}\label{app-rb-2pt}
...
%\begin{proof}
Let $S$ be a string constraint with \PT{}s, replaceall, concatenation, and reverse.

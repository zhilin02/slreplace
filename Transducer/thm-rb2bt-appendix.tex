...
\section{Proof of Theorem~\ref{thm-rb-2pt}: $k$-\RBPPT{} are EXPSPACE-Complete}\label{app-rb-2pt}
...
%
To the left of the program we give the output of an example run with the intput
$x = a b c a b c$.
%
\[
    \begin{array}{rcll}

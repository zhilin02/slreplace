...
for more, see \cite{Kozen-automata}. 
...
transition relation  of type $\transrel\subseteq \controls \times 
    \ialphabet\times \{\Left, \Stay, \Right\}\times \controls$.
...
will often write $\transrel\subseteq \controls \times \ialphabet \times \controls$.
\end{definition}
In the sequel, we will often only tacitly mention $\ialphabet$, $\EndLeft$,
and $\EndRight$ in $\Aut$.

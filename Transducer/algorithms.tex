...
based on the notion of recognisable relations. We assume that, for each assertion \ASSERT{$g(x_1,\ldots,x_n)$}, it is satisfied that $g(x_1,\ldots,x_n)$ is a conjunction of regular constraints

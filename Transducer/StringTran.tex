...
\begin{definition}[Recognisable relation]
	Given a finite alphabet $\Sigma$, a  relation $R\subseteq \Sigma^*\times \cdots\times \Sigma^*$ is \emph{recognisable}  if $R=\bigcup_{i=1}^n L_i\times L_i'$ where $L_i$ and $L_i'$ are both regular languages. 
%	
